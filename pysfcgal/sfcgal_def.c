 ...
 * @ingroup capi
 */
int                       sfcgal_geometry_is_valid( const sfcgal_geometry_t* );
 ...
 * @ingroup capi
 */
int                       sfcgal_geometry_is_valid_detail( const sfcgal_geometry_t* geom, char** invalidity_reason, sfcgal_geometry_t** invalidity_location );
 ...
 * @ingroup capi
 */
void                      sfcgal_geometry_as_text_decim( const sfcgal_geometry_t*, int numDecimals, char** buffer, size_t* len );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_linestring_num_points( const sfcgal_geometry_t* linestring );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_linestring_point_n( const sfcgal_geometry_t* linestring, size_t i );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*        sfcgal_triangle_create_from_points( const sfcgal_geometry_t* pta,
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_triangle_vertex( const sfcgal_geometry_t* triangle, int i );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*        sfcgal_polygon_create_from_exterior_ring( sfcgal_geometry_t* ring );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_polygon_exterior_ring( const sfcgal_geometry_t* polygon );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_polygon_num_interior_rings( const sfcgal_geometry_t* polygon );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_polygon_interior_ring_n( const sfcgal_geometry_t* polygon, size_t i );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_geometry_collection_num_geometries( const sfcgal_geometry_t* collection );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_geometry_collection_geometry_n( const sfcgal_geometry_t* collection , size_t i );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_polyhedral_surface_num_polygons( const sfcgal_geometry_t* polyhedral );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_polyhedral_surface_polygon_n( const sfcgal_geometry_t* polyhedral, size_t i );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_triangulated_surface_num_triangles( const sfcgal_geometry_t* tin );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_triangulated_surface_triangle_n( const sfcgal_geometry_t* tin, size_t i );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*        sfcgal_solid_create_from_exterior_shell( sfcgal_geometry_t* shell );
 ...
 * @ingroup capi
 */
size_t                    sfcgal_solid_num_shells( const sfcgal_geometry_t* solid );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*  sfcgal_solid_shell_n( const sfcgal_geometry_t* solid, size_t i );
 ...
 */
// TODO
//void                      sfcgal_solid_add_shell( sfcgal_geometry_t* solid, sfcgal_geometry_t* shell );
 ...
 * @ingroup capi
 */
sfcgal_prepared_geometry_t* sfcgal_prepared_geometry_create_from_geometry( sfcgal_geometry_t* geometry, srid_t srid );
 ...
 * @ingroup capi
 */
const sfcgal_geometry_t*    sfcgal_prepared_geometry_geometry( const sfcgal_prepared_geometry_t* prepared );
 ...
 * @ingroup capi
 */
srid_t                      sfcgal_prepared_geometry_srid( const sfcgal_prepared_geometry_t* prepared );
 ...
 * @ingroup capi
 */
void                        sfcgal_prepared_geometry_set_srid( sfcgal_prepared_geometry_t* prepared, srid_t );
 ...
 * @ingroup capi
 */
int                         sfcgal_geometry_intersects( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
int                         sfcgal_geometry_intersects_3d( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_intersection( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_intersection_3d( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_difference( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_difference_3d( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_union( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_union_3d( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_convexhull( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_convexhull_3d( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
double                      sfcgal_geometry_volume( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
double                      sfcgal_geometry_area( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
double                      sfcgal_geometry_area_3d( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
int                         sfcgal_geometry_is_planar( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
int                         sfcgal_geometry_orientation( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_tesselate( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_triangulate_2dz( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_extrude( const sfcgal_geometry_t* geom, double ex, double ey, double ez );
 ...
 * @ingroup detail
 */
sfcgal_geometry_t*          sfcgal_geometry_make_solid( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_force_lhr( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_force_rhr( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
double                      sfcgal_geometry_distance( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
double                      sfcgal_geometry_distance_3d( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_round( const sfcgal_geometry_t* geom, int r );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_minkowski_sum( const sfcgal_geometry_t* geom1, const sfcgal_geometry_t* geom2 );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_offset_polygon( const sfcgal_geometry_t* geom, double radius );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_straight_skeleton( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_straight_skeleton_distance_in_m( const sfcgal_geometry_t* geom );
 ...
 * @ingroup capi
 */
sfcgal_geometry_t*          sfcgal_geometry_line_sub_string( const sfcgal_geometry_t* geom, double start, double end );
...
const char* sfcgal_full_version();
